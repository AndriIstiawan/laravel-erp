...
<form id="jxForm1" novalidate="novalidate" method="POST" action="{{ route('segment-attributes.update',['id' => $attr->id]) }}" enctype="multipart/form-data">
      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            {{ csrf_field() }}
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$attr->name}}" id="name" name="name" placeholder="Name" aria-describedby="name-error">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$attr->slug}}" id="slug" name="slug" placeholder="Slug" aria-describedby="slug-error" readonly="">
              ...
              <div class="form-group">
                ...
                <select id="type" name="type" class="form-control" style="width: 100%;" aria-describedby="type-error" required>
                  <option value=""></option>
                  <option value="URL" {{($attr->type == 'URL'?'selected':'')}}>Url</option>
                  <option value="Icon" {{($attr->type == 'Icon'?'selected':'')}}>Icon</option>
                  <option value="TextArea"  {{($attr->type == 'TextArea'?'selected':'')}}>Text Area</option>
                  <option value="Media"  {{($attr->type == 'Media'?'selected':'')}}>Media</option>
                </select>
                ...
                <div class="URL box">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" value="{{$attr->url}}" id="url" name="url" aria-describedby="url-error" class="form-control" placeholder="Https://Url.com">
                ...
                <div class="Icon box">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" value="{{$attr->icon}}" id="icon" name="icon" aria-describedby="icon-error" class="form-control" placeholder="fa fa-list" onkeyup="$('#iconpreview').attr('class', $(this).val())">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <i id="iconpreview" class="{{$attr->icon}}"></i>
                  </div>
                  <div class="form-group col-md-12">
                    <label class="col-form-label" for="urlicon">
                      <strong>Url</strong>
                    </label>
                    <input type="text" id="urlicon" value="{{$attr->urlicon}}" name="urlicon" aria-describedby="urlicon-error" class="form-control" placeholder="Https://Url.com">
                ...
                <div class="TextArea box">
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="textArea" id="textArea" aria-describedby="textArea-error" value="{{$attr->textArea}}" class="form-control">{{$attr->textArea}}</textarea>
                ...
                <div class="Media box">
                    ...
                    <div class="card">
                      ...
                      <div class="form-group">
                        <div class="text-center">
                          <img class="rounded mediaPrev" src="{{(isset($attr->media)?asset('img/avatars/'.$attr->media):asset('img/fiture-logo.png'))}}" " style="width: 200px; height: 200px;">
                        </div>
                        </div>
                        <div class="form-group">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" value="{{$attr->urlmedia}}" id="url" name="urlmedia" aria-describedby="url-error" class="form-control">
                    <em id="url-error" class="error invalid-feedback">Please enter a url</em>
                  </div>
                </div>
          </div>
          <div class="card-footer">
            <div class="btn-group">
              <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
              <button type="submit" class="btn btn-success" name="signup" value="Sign up">Save and Continue</button>
            </div>
...
<script>
  ...
  $("#jxForm1").validate({
    ...
    messages:{
      ...
      urlmedia:{ required:'Please enter a url' 
      },
