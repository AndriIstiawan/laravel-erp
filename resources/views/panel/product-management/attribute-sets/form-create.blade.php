...
<form id="jxForm" novalidate="novalidate" method="POST" action="{{ route('attribute-sets.index') }}">
  <div class="modal-header"><h4 class="modal-title">Create New Attribut Sets</h4>
  </div>
