		...
		<div class="row">
			<div class="col-sm-6">
				...
				<button type="button" class="btn btn-primary" data-toggle="modal"
					 data-target="#primaryModal" data-link="{{route('attribute-sets.create')}}" 
					 onclick="funcModal($(this))">
				<i class="fa fa-plus"></i>&nbsp; New Attribute Sets
				</button>
				</p>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<i class="fa fa-align-justify"></i> Attribute Sets Table
					</div>
					<div class="card-body">
