@extends('master')
@section('content')
<form id="jxForm" novalidate="novalidate" method="POST" action="{{ route('packaging.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
        ...
        <div class="form-group">
          <div class="option-card">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="code" name="code" placeholder="PKG01" aria-describedby="code-error" value="{{$code}}" readonly>
