                ...
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="displayName" name="displayName" placeholder="Display Name" aria-describedby="displayName-error"
                                        value="{{(isset($member->display_name)?$member->display_name:'')}}">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Fullname" aria-describedby="fullname-error"
                                        value="{{(isset($member->fullname)?$member->fullname:'')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-8">
                                    ...
                                    <select id="title" class="form-control" name="title" aria-describedby="title-error">
                                        ...
                                        @if($member->title != 'Bapak' && $member->title != 'Ibu')
                                        <option value="{{$member->title}}" selected>{{$member->title}}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-8">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email (optional)" aria-describedby="email-error" value="{{(isset($member->email)?$member->email:'')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    ...
                                    <select id="mobile" class="form-control" name="mobile[]" multiple aria-describedby="mobile-error">
                                        <option value=""></option>
                                        @foreach($member->mobile as $mobile_list)
                                        <option value="{{$mobile_list['number']}}" selected>{{$mobile_list['number']}}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="col-md-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="company" name="company" placeholder="Company (optional)" value="{{(isset($member->company)?$member->company:'')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-8">
                                    ...
                                    <select id="negara" class="form-control" name="negara">
                                        <option value=""></option>
                                        <option value="INDONESIA" {{($member->negara == 'INDONESIA'?'selected':'')}}>INDONESIA</option>
                                        @if($member->negara != 'INDONESIA')
                                        <option value="{{$member->negara}}" selected>{{$member->negara}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    ...
                                    <select id="phone" class="form-control" name="phone[]" multiple>
                                        <option value=""></option>
                                        @foreach($member->phone as $phone_list)
                                        <option value="{{$phone_list['number']}}" selected>{{$phone_list['number']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="input-group col-md-8">
                                    ...
                                    <select id="sales" class="form-control" name="sales" aria-describedby="sales-error">
                                        <option value=""></option>
                                        <?php $sales_selected = $member->sales[0]['detail'][count($member->sales[0]['detail'])-1]['_id'] ?> @foreach($sales as $sales_list)
                                        <option value="{{$sales_list->id}}" {{($sales_selected==$sales_list->id?'selected':'')}}>{{$sales_list->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="remarks" name="remarks" placeholder="Remarks (optional)" value="{{$member->remarks}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    ...
                                    <select id="shippingAddress" class="form-control" name="shippingAddress[]" multiple aria-describedby="shippingAddress-error">
                                        <option value=""></option>
                                        @foreach($member->shipping_address as $shipping_list)
                                        <option value="{{$shipping_list['address']}}" selected>{{$shipping_list['address']}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="division-list">
                                <?php $i=0; ?>
                                @foreach($member->divisi as $divisi_list)
                                <?php $i++; ?>
                                <div class="row div-items">
                                    <input type="hidden" class="arrDiv" name="arrDiv[]" value="{{$i}}">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control div-name" id="divisiName{{$i}}" name="divisiName{{$i}}" placeholder="Divisi Name" 
                                                    aria-describedby="divisiName{{$i}}-error" value="{{$divisi_list['divisi_name']}}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" data-original-title="ex: Product BP"></i>
                                                    </span>
                                                </div>
                                                <em id="divisiName{{$i}}-error" class="error invalid-feedback div-em-name"></em>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select id="divisiType{{$i}}" class="form-control div-type" name="divisiType{{$i}}" aria-describedby="divisiType{{$i}}-error">
                                                    <option value=""></option>
                                                    <option value="{{$divisi_list['divisi_type']}}" selected>{{$divisi_list['divisi_type']}}</option>
                                                </select>
                                            </div>
                                            <em id="divisiType{{$i}}-error" class="error invalid-feedback div-em-type"></em>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group row">
...
<script>
    ...
    //add set select and rule
    <?php $i = 0; ?>
    @foreach($member->divisi as $divisi_list)
    <?php $i++; ?>
    //set select2 divisi type
    $('#divisiType' + {{$i}}).select2({
        theme: "bootstrap",
        placeholder: 'Divisi type',
        tags: true
    }).change(function () {
