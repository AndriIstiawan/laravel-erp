                ...
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-8">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email" aria-describedby="email-error" value="{{(isset($member->email)?$member->email:'')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                ...
                <div class="col-md-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="company" name="company" placeholder="Company" value="{{(isset($member->company)?$member->company:'')}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
                            ...
                            <div class="form-group row">
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" id="remarks" name="remarks" placeholder="Remarks" value="{{$member->remarks}}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">
