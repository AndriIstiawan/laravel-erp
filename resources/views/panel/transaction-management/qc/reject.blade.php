...
<form id="jxForm" novalidate="novalidate" method="POST" action="{{ route('qc.store') }}" enctype="multipart/form-data">
{{ csrf_field() }}
  ...
  <div class="col-md-8">
    ...
    <div class="card">
      <div class="card-header">
        <i class="fa fa-align-justify"></i> Reject
              ...
              <label class="col-form-label">Weight</label>
              	...
              	<input type="text" class="form-control" id="total" name="total" value="{{$total}}" readonly>
						...
						<div class="form-group">
							...
							<div class="input-group">
              	<input type="text" class="form-control" id="realisasi" name="realisasi" value="{{$realisasi}}" readonly>
								<span class="input-group-text">Kg</span>
							</div>
            </div>
            <div class="form-group">
							<label class="col-form-label">Note Reject</label>
							<div class="input-group">
