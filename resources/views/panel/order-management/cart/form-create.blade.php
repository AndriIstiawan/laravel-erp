        ...
        <div class="animated fadeIn">
          ...
          <div class="row">
           ...
           <!--  <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <span><i class="fa fa-truck"></i> Courier</span>
                </div>
                <div class="card-body">
                  <table class="table table-condensed">
                    <thead>
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                    <div class="col-md-12">
                      ...
                      <tbody>
                        <tr>
                          <td class="vertical-align-middle">{{$orders->product}}</td>
                          <td class="vertical-align-middle">{{$orders->price}}</td>
                          <td class="vertical-align-middle">{{$orders->quantity}}</td>
                          <td class="vertical-align-middle text-right">Rp {{$orders->price}}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <div class="col-md-12">
                    <table class="table table-condensed">
                      ...
                      <tr>
                        ...
                        <td class="text-right"><strong>Rp {{$orders->price}}</strong></td>
                      </tr>@endforeach
                    </tbody></table>
                  </div>
