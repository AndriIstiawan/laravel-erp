				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs" id="myTab1" role="tablist">
							...
							<!-- <li class="nav-item">
								<a class="nav-link" id="bank-tab" data-toggle="tab" href="#bank" role="tab" aria-controls="home" aria-selected="false">Bank</a>
							</li> -->
						</ul>
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															<label class="switch switch-text switch-pill switch-success">
																<input type="checkbox" class="switch-input" id="siteStatus" name="siteStatus" {{($setting->site_status? 'checked': '')}}
																    tabindex="-1">
...
<script>
    function readURL(input, parent) {
		if (input.files && input.files[0]) {
			...
			reader.onload = function (e){ $('.'+parent+'Prev').attr('src', e.target.result); }
