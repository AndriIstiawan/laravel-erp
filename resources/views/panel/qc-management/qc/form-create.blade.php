	...
	function act(action){
		switch(action) {
		    case 'continue':
		        ...
		        break;
		    case 'new':
		        window.open("{{ route('qc-staff.create') }}/?new=qc-staff", "_self");
		        break;
		    case 'exit':
		        window.open("{{ route('qc-staff.index') }}/?new=qc-staff", "_self");
		}
	}
